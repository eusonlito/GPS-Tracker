...
<li>
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        <li>
            <a href="{{ route('refuel.index') }}"
                class="side-menu {{ ($ROUTE === 'refuel.index') ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('list')</div>
        ...
        <li>
            <a href="{{ route('refuel.create') }}"
                class="side-menu {{ ($ROUTE === 'refuel.create') ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="{{ route('refuel.map') }}"
                class="side-menu {{ ($ROUTE === 'refuel.map') ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('map')</div>
...
<li>
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        ...
        <li>
            <a href="{{ route('monitor.queue') }}"
                class="side-menu {{ ($ROUTE === 'monitor.queue') ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="{{ route('monitor.requirements') }}"
                class="side-menu {{ ($ROUTE === 'monitor.requirements') ? 'side-menu--active' : '' }}">
