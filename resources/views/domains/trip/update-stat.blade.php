...
<div class="box p-7 mt-5">
    ...
    <div class="progress h-6">
        <div class="progress-bar p-3 whitespace-nowrap" style="width: 100%" role="progressbar" aria-valuenow="{{ $stats['speed']['max_percent'] }}" aria-valuemin="0" aria-valuemax="100">{{ __('trip-update-stat.distance.total') }}: @distanceHuman($row->distance)</div>
    </div>
</div>
...
<div class="box p-7 mt-5">
    ...
    <div class="progress h-6">
        <div class="progress-bar p-3 whitespace-nowrap" style="width: {{ $stats['speed']['max_percent'] }}%" role="progressbar" aria-valuenow="{{ $stats['speed']['max_percent'] }}" aria-valuemin="0" aria-valuemax="100">{{ __('trip-update-stat.speed.max') }}: {{ $stats['speed']['max'] }} km/h</div>
    </div>

    <div class="progress h-6 mt-2">
        <div class="progress-bar p-3 whitespace-nowrap" style="width: {{ $stats['speed']['avg_percent'] }}%" role="progressbar" aria-valuenow="{{ $stats['speed']['avg_percent'] }}" aria-valuemin="0" aria-valuemax="100">{{ __('trip-update-stat.speed.avg') }}: {{ $stats['speed']['avg'] }} km/h</div>
    </div>
