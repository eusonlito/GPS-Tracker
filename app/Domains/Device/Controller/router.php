...
Route::group(['middleware' => ['user-auth']], static function () {
    ...
    Route::any('/device/{id}/device-alarm-notification/{device_alarm_notification_id}/closed-at', UpdateDeviceAlarmNotificationUpdateClosedAt::class)->name('device.update.device-alarm-notification.update.closed-at');
