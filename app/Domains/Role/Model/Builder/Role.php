...
use App\Domains\Role\Model\RoleVehicle as RoleVehicleModel;
...
class Role extends BuilderAbstract
{
    ...
    {
        return $this->whereIn('id', RoleVehicleModel::query()->selectOnly('Role_id')->byVehicleId($vehicle_id));
    }
    ...
    {
        return $this->whereIn('id', RoleVehicleModel::query()->selectOnly('Role_id')->byVehicleIdEnabled($vehicle_id));
    }
    ...
    {
        return $this->whereIn('id', RoleVehicleModel::query()->selectOnly('Role_id')->byVehicleSerial($serial));
    }
