...
use App\Domains\Expense\Controller\Service\Update as ControllerService;
...
class Update extends ControllerAbstract
{
    ...
    public function __invoke(int $id): Response|RedirectResponse
    {
        ...
        $this->meta('title', __('expense-update.meta-title', ['title' => $this->row->name]));

        return $this->page('expense.update', $this->data());
    }
    ...
    protected function update(): RedirectResponse
    {
        ...
        $this->sessionMessage('success', __('expense-update.success'));
    ...
    protected function delete(): RedirectResponse
    {
        ...
        $this->sessionMessage('success', __('expense-update.delete-success'));
